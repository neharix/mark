...
var inputCardNumber = document.getElementsByClassName('cardnumber');
var inputExpirationDate = document.getElementsByClassName('expiration-date');

for(var i=0; i<inputCardNumber.length; i++) {
new Formatter(inputCardNumber[i], {
    'pattern': '{{9999}}\ {{9999}}\ {{9999}}\ {{9999}}'
});
}

for(var i=0; i<inputExpirationDate.length; i++) {
new Formatter(inputExpirationDate[i], {
    'pattern': '{{99}}\/{{99}}'
});
}
